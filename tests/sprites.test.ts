...
import { ENEMY_FRAMES_RIME } from '../src/gfx/data/enemySpritesRime';
import { ENEMY_FRAMES_FOUNDRY } from '../src/gfx/data/enemySpritesFoundry';
...
import { TILE_FRAMES_RIME } from '../src/gfx/data/tileSpritesRime';
import { TILE_FRAMES_FOUNDRY } from '../src/gfx/data/tileSpritesFoundry';
...
const SHEETS: Record<string, Record<string, string[][]>> = {
  ...
  'enemies-rime': ENEMY_FRAMES_RIME,
  'enemies-foundry': ENEMY_FRAMES_FOUNDRY,
  tiles: TILE_FRAMES,
  'tiles-canyon': TILE_FRAMES_CANYON,
  'tiles-moss': TILE_FRAMES_MOSS,
  'tiles-ash': TILE_FRAMES_ASH,
  'tiles-rime': TILE_FRAMES_RIME,
  'tiles-foundry': TILE_FRAMES_FOUNDRY,
