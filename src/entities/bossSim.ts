...
const RUSTJAW: BossConfig = {
  ...
  bodyH: 20,
  walkSpeed: 40,
  chargeSpeed: [230, 340, 420],
  telegraphS: [0.75, 0.52, 0.4],
  stunS: [2.4, 2.0, 1.7],
  walkS: [1.6, 1.25, 0.9],
  recoverS: 0.5,
  volleyCount: [0, 4, 6],
...
const COGLAR: BossConfig = {
  ...
  bodyH: 30,
  walkSpeed: 42,
  chargeSpeed: [250, 0, 380], // phase 1 ram / phase 3 overdrive
  telegraphS: [0.85, 0.6, 0.46],
  stunS: [2.4, 2.1, 1.8],
  walkS: [1.7, 1.3, 1.0],
  recoverS: 0.55,
  volleyCount: [3, 5, 8],
  shotSpeed: 170,
  leapVX: [0, 195, 0], // phase 2 leap
  leapImpulse: 620,
  shockSpeed: 175,
  hoverH: 0,
  diveSpeed: [0, 0, 0],
  riseSpeed: 0,
  bounces: [0, 0, 3], // phase 3 overdrive ricochets three times
};
...
const SHIVERBACK: BossConfig = {
  ...
  bodyH: 24,
  walkSpeed: 35,
  chargeSpeed: [200, 285, 345], // the roll speed
  telegraphS: [0.9, 0.64, 0.5],
  stunS: [2.5, 2.1, 1.8],
  walkS: [1.7, 1.3, 1.0],
  recoverS: 0.6,
  volleyCount: [0, 4, 6],
