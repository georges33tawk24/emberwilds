...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'foundry', name: 'Into the Foundry Heart', desc: 'Clear all of World 6', test: (c) => c.data.levelUnlocked >= 28 },
  ...
  { id: 'heart_whole', name: 'The Heart Made Whole', desc: 'Defeat Baron Coglar', test: (c) => c.data.stats.bossesDefeated >= 5 },
